...
* [摘录自卷一TCP章节](#摘录自卷一tcp章节)
* [1\. TCP:传输控制协议\-17](#1-tcp传输控制协议-17)
  * [1\.1 引言](#11-引言)
  * [1\.2 TCP的服务](#12-tcp的服务)
  * [1\.3 TCP的首部](#13-tcp的首部)
* [2\. TCP连接的建立与终止\-18](#2-tcp连接的建立与终止-18)
  * [2\.1 连接的建立与终止](#21-连接的建立与终止)
    * [2\.1\.1 建立连接协议](#211-建立连接协议)
    * [2\.1\.2 连接终止协议](#212-连接终止协议)
  * [2\.2 连接建立的超时](#22-连接建立的超时)
    * [2\.2\.1 第一次超时时间](#221-第一次超时时间)
    * [2\.2\.2 服务类型字段](#222-服务类型字段)
  * [2\.3 最大报文段长度](#23-最大报文段长度)
  * [2\.4 TCP的半关闭](#24-tcp的半关闭)
  * [2\.5 TCP的状态变迁图](#25-tcp的状态变迁图)
    * [2\.5\.1 2MSL等待状态](#251-2msl等待状态)
    * [2\.5\.2 平静时间的概念](#252-平静时间的概念)
    * [2\.5\.2 FIN\_WAIT\_2 状态](#252-fin_wait_2-状态)
  * [2\.6 复位报文段](#26-复位报文段)
    * [2\.6\.1 到不存在的端口的连接请求](#261-到不存在的端口的连接请求)
    * [2\.6\.2 异常终止一个连接](#262-异常终止一个连接)
    * [2\.6\.3 检测半打开连接](#263-检测半打开连接)
  * [2\.7 同时打开](#27-同时打开)
  * [2\.8 同时关闭](#28-同时关闭)
  * [2\.9 TCP选项](#29-tcp选项)
  * [2\.10 TCP服务器的设计](#210-tcp服务器的设计)
    * [2\.10\.1 TCP服务器端口号](#2101-tcp服务器端口号)
    * [2\.10\.2 限定的本地IP地址](#2102-限定的本地ip地址)
    * [2\.10\.3 限定的远端IP地址](#2103-限定的远端ip地址)
    * [2\.10\.4 呼入连接请求队列](#2104-呼入连接请求队列)
* [3\. TCP的交互数据流\-19](#3-tcp的交互数据流-19)
  * [3\.1 交互式输入](#31-交互式输入)
  * [3\.2 经受时延的确认](#32-经受时延的确认)
  * [3\.3 Nagle算法](#33-nagle算法)
  * [3\.4 窗口大小通知](#34-窗口大小通知)
* [4\. TCP的成块数据流\-20](#4-tcp的成块数据流-20)
  * [4\.1 引言](#41-引言)
  * [4\.2 正常数据流](#42-正常数据流)
  * [4\.3 滑动窗口](#43-滑动窗口)
  * [4\.4 窗口大小](#44-窗口大小)
  * [4\.5 PUSH标志](#45-push标志)
  * [4\.6 慢启动](#46-慢启动)
  * [4\.7 成块数据的吞吐量](#47-成块数据的吞吐量)
    * [4\.7\.1 带宽时延乘积](#471-带宽时延乘积)
    * [4\.7\.2 拥塞](#472-拥塞)
  * [4\.8 紧急方式](#48-紧急方式)
* [5\. TCP的超时与重传\-21](#5-tcp的超时与重传-21)
  * [5\.1 引言](#51-引言)
  * [5\.2 超时和重传的简单例子](#52-超时和重传的简单例子)
  * [5\.3 往返时间测量（没看懂 \- 直接看5\.4例子）](#53-往返时间测量没看懂---直接看54例子)
  * [5\.4 往返时间RTT的例子](#54-往返时间rtt的例子)
  * [5\.5 拥堵举例](#55-拥堵举例)
  * [5\.6 拥堵避免算法](#56-拥堵避免算法)
  * [5\.7 快速重传与快速恢复算法](#57-快速重传与快速恢复算法)
  * [5\.8 拥塞举例（续）](#58-拥塞举例续)
* [6\. TCP的坚持定时器\-22](#6-tcp的坚持定时器-22)
  * [6\.1 引言](#61-引言)
  * [6\.2 一个例子](#62-一个例子)
  * [6\.3 糊涂窗口综合症（未看）](#63-糊涂窗口综合症未看)
* [7\. TCP的保活定时器\-23](#7-tcp的保活定时器-23)
  * [7\.1 引言](#71-引言)
  * [7\.2 描述](#72-描述)
  * [7\.3 保活举例](#73-保活举例)
    * [7\.3\.1 另一端崩溃](#731-另一端崩溃)
    * [7\.3\.2 另一端崩溃并重新启动](#732-另一端崩溃并重新启动)
    * [7\.3\.3 另一端不可达](#733-另一端不可达)
